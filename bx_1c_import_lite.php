...
<a style='color:red;' href="javascript:status='stop'">остановить импорт</a>
<hr>
...
<script>
    ...
    function query_1c(file) {
        ...
        if (zup_import == true) {
            ...
            // r = "/bitrix/admin/1c_exchange_ext.php?type=catalog&mode=import&filename=" + file;
        }
    ...
    function reset() {
        ...
        q = "bx_1c_import_lite.php?reset=y";
